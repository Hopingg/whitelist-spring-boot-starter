package com.hoping.middleware.whitelist;

import com.hoping.middleware.whitelist.annotation.DoWhiteList;
...
public class DoJoinPoint {
    ...
    @Pointcut("@annotation(com.hoping.middleware.whitelist.annotation.DoWhiteList)")
